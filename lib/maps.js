...
//                $("div.hide2").slideToggle(1000);
                $("div.route").fadeToggle(500);

                $("div.options").slideDown(1500);
...
//                xmlhttp.open("GET","post_test.php",true);
                xmlhttp.open("POST", "post_test.php?routeStart=" + start + "&routeEnd=" + end, true);
                xmlhttp.send();
                ...
                directionsService.route(request, function(response, status) {
                    if (status == google.maps.DirectionsStatus.OK) {
                        ...
                        if (status == 'ZERO_RESULTS') {
                            ...
                            alert('De begin of eind locatie is niet ingevoerd.');
