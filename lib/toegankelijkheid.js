$(document).ready(function(){
    ...
    $("#menu img").click(function(){
        ...
        if (contrast === 0)
        {
            ...
            $("#routeDetails #earlier_travel_options .arrow_top").css(backgroundColor);
            $("#routeDetails #later_travel_options .arrow_bottom").css(backgroundColor);
        ...
        {           
            ...
            $("#questionLink a").removeAttr('style');
    ...
    $("#routeDetails #earlier_travel_options").mouseover(function(){
        ...
        if (contrast === 1)
        {
            ...
            $("#routeDetails #earlier_travel_options .arrow_top").css(backgroundColorGreen);
    ...
    $("#routeDetails #later_travel_options").mouseover(function(){
        ...
        if (contrast === 1)
        {
            ...
            $("#routeDetails #later_travel_options .arrow_bottom").css(backgroundColorGreen);
