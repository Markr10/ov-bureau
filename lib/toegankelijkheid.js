$(document).ready(function(){
    ...
    $("#menu img").click(function(){
        ...
        if (contrast === 0)
        {
            ...
            $("#routeDetails #earlier_travel_options, #routeDetails #later_travel_options").css(backgroundColorGreen);
            ...
            $("#routeDetails #earlier_travel_options, #routeDetails #later_travel_options").css(textColorWhite);
        ...
        else
        {
            ...
            $("#routeDetails .detailedRoute:hover .time, #routeDetails #earlier_travel_options, #routeDetails #later_travel_options").removeAttr('style');
